...
export function LoginHeader() {
  return (
    <div className="flex flex-col items-center">
      <div className="pb-2">
        <div className="rounded-full bg-white/80 px-4 pt-4 pb-5 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] outline -outline-offset-1 outline-red-300/20 backdrop-blur-[2px]">
