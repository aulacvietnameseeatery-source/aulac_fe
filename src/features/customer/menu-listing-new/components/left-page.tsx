...
import { MenuItem } from './menu-card'; // Import interface
...
export const LeftPage = ({ onOrder }: PageProps) => {

    // Hàm xử lý wrapper để tạo dữ liệu món ăn tại chỗ (cho món Signature & Side)
    ...
    return (
        <div className="w-[44.1%] ml-[4%] relative flex flex-col h-[103.3%] mt-[-0.8%]">
            {/* ... (Giữ nguyên Background Img & Gradient) ... */}
            ...
            <div className="absolute inset-3 pl-[12%] pr-[9%] py-[8%] flex flex-col z-10">
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center mt-[-10%]">
                    {/* ... (Giữ nguyên UI Text/Image Signature) ... */}
                    <div className="mb-2 pb-4  text-[10px]  uppercase tracking-widest">
                        <span className="text-[#C5A059] text-[20px] tracking-[0.3em] uppercase border-b border-[#C5A059]/50 pb-1">Chef's Selection</span>
                    </div>
                    ...
                    <h2 className="font-display text-2xl text-[#C5A059] mb-1 leading-tight">Risotto al Tartufo</h2>
                    <p className="font-sans text-[#E5D9B6]/80 text-[10px] font-light mt-1 max-w-[90%] leading-relaxed line-clamp-3">
                        Arborio rice slow-cooked with black truffle shavings...
                    </p>
                    ...
                    <div className="mt-3 flex items-center gap-3">
                        ...
                        <button
                            onClick={(e) => handleQuickOrder(e, { id: 'sig-1', name: 'Risotto al Tartufo', price: 42, image: '/images/menu-listing/menu-grid/Grilled Premium Wagyu Beef.png' })}
                            className="px-4 py-1 bg-[#C5A059] text-[#0f172a] text-[9px] font-bold uppercase tracking-widest hover:bg-white transition-colors shadow-lg active:scale-95"
                        >
                            Order
                        </button>
                    </div>
                ...
                <div className="mt-auto w-full pt-3 border-t border-[#C5A059]/20 flex flex-col gap-3">
                    ...
                    <div className="flex items-center gap-3 bg-[#0f172a]/40 p-2 border border-[#C5A059]/10 rounded hover:border-[#C5A059]/40 transition-all cursor-pointer group">
                        ...
                        <div className="flex-1">
                            <h4 className="text-[#C5A059] text-[10px] uppercase font-bold mb-0.5">Asparagi al Burro</h4>
                        ...
                        <div className="flex flex-col items-end gap-1">
                            ...
                            <button
                                onClick={(e) => handleQuickOrder(e, { id: 'side-1', name: 'Asparagi al Burro', price: 12, image: '/images/menu-listing/menu-grid/Grilled Premium Wagyu Beef.png' })}
                                className="text-[8px] text-[#C5A059] border border-[#C5A059] px-2 py-0.5 hover:bg-[#C5A059] hover:text-black uppercase"
                            >Order</button>
                        </div>
                    </div>
                    {/* Side Dish 2 tương tự... */}
                    <div className="flex items-center gap-3 bg-[#0f172a]/40 p-2 border border-[#C5A059]/10 rounded hover:border-[#C5A059]/40 transition-all cursor-pointer group">
                        <div className="w-12 h-10 overflow-hidden rounded border border-[#C5A059]/20 shrink-0">
                            <img src="/images/menu-listing/menu-grid/Grilled Premium Wagyu Beef.png" className="w-full h-full object-cover"/>
                        </div>
                        <div className="flex-1">
                            <h4 className="text-[#C5A059] text-[10px] uppercase font-bold mb-0.5">Patate Arrosto</h4>
                        ...
                        <div className="flex flex-col items-end gap-1">
                            ...
                            <button
                                onClick={(e) => handleQuickOrder(e, { id: 'side-2', name: 'Patate Arrosto', price: 9, image: '/images/menu-listing/menu-grid/Grilled Premium Wagyu Beef.png' })}
                                className="text-[8px] text-[#C5A059] border border-[#C5A059] px-2 py-0.5 hover:bg-[#C5A059] hover:text-black uppercase"
                            >Order</button>
                        </div>
                    </div>
