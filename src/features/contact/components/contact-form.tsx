    ...
    <div className="relative">
        <div className="sticky top-20 bg-white p-8 md:p-12 border rounded-sm shadow-lg flex flex-col gap-8">
            <div className="flex flex-col gap-2 shrink-0">
                 <h3 className="font-serif text-2xl text-[#1A3951] sticky top-0 bg-white z-20">Send an Inquiry</h3>
            </div>
            ...
            <form className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                   <label className="tracking-[1px] uppercase text-[10px] font-bold text-slate-400">Subject</label>
                ...
                <div className="flex flex-col gap-2">
                   <label className="tracking-[1px] uppercase text-[10px] font-bold text-slate-400">Your Message</label>
                   <textarea 
                 ...
                 <button className="w-full h-14 bg-[#1A3951] text-white rounded-sm mt-4 hover:bg-[#152e42] transition shadow-lg flex items-center justify-center gap-2 group shrink-0">
                   <span className="tracking-[3px] uppercase text-xs font-bold">Send Message</span>
                 </button>
            </form>
        </div>
    </div>
