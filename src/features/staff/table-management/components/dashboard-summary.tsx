...
const StatCard: React.FC<{
  ...
  <div className="min-w-0 rounded-lg border border-slate-200 bg-white px-3.5 py-3 shadow-sm">
...
const ReservationCard: React.FC<{ r: IncomingReservation }> = ({ r }) => {
  ...
  return (
    <div className="flex w-44 shrink-0 flex-col justify-between rounded-lg border border-slate-200 bg-white p-3 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md">
      {/* Time + status row */}
