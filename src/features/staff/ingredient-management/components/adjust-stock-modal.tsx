...
export const AdjustStockModal: React.FC<AdjustStockModalProps> = ({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (type === "export" && quantity > ingredient.quantityOnHand) {
            toast.error(`Cannot export more than current stock (${ingredient.quantityOnHand} ${ingredient.unitLvId}).`);
            return;
        }
    ...
    return (
        ...
        >
            <div className="p-5 space-y-4">
              ...
              {ingredient.quantityOnHand} {ingredient.unitLvId}
            </span>
                    </div>
                </div>
                ...
                <div className="relative">
                    <ALInput
                        title={`Quantity (${ingredient.unitLvId})`}
                        required
                        type="number"
                        min={0.1}
                        step={0.1}
