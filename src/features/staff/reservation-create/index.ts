// Components
export { CustomerSection } from './components/customer-section';
...
// Types 
// export type { BookingSource, BookingStatus, CreateReservationRequest, CustomerDto, CustomerType, TableAvailabilityDto } from './types/types';