        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6 border-b border-gray-100 pb-6">
            ...
            <div>
                ...
                <div className="relative">
                    <input type="text" placeholder="dd/mm/yyyy" className="w-full pl-3 pr-10 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-blue-500" />
            ...
            <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Customer<span className="text-red-500 ms-1">*</span></label>
                <div className="relative">
                    <button
                        onClick={() => setIsCustomerDropdownOpen(!isCustomerDropdownOpen)}
                        className="w-full bg-white px-3 py-2 border border-gray-300 rounded-lg text-sm text-left flex justify-between items-center focus:outline-none"
                    >
                        Select
                    </button>
                    ...
                    {isCustomerDropdownOpen && (
                        <div className="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg p-3">
                            ...
                            <div className="flex flex-col gap-2 max-h-40 overflow-y-auto">
                                {["Walk-in Customer", "Sue Allen", "Frank Barrett", "Kelley Davis", "Jim Vickers"].map((name, idx) => (
