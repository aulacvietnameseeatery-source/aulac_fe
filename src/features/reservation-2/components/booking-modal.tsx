...
interface BookingModalProps {
    ...
    onClose: () => void;
    onConfirm: () => void;
    tableData: TableAvailabilityDto & { reservedTime?: string; } | null;
    guestInfo?: {
        name: string;
        phone: string;
        email?: string;
...
export default function BookingModal({ isOpen, onClose, onConfirm, tableData, guestInfo }: BookingModalProps) {
    ...
    // Format date/time from ISO reservedTime if available, or just use placeholders/props?
    // The UI displays Date and Time separately. Let's parse them if exists
    const dateObj = tableData.reservedTime ? new Date(tableData.reservedTime) : new Date();
            ...
            <div className="booking-modal-container fade-in zoom-in animate-in">
                ...
                <div className="booking-modal-image-section">
                    ...
                    <div className="booking-modal-image-overlay">
                        ...
                        <h2 className="text-5xl font-bold">{tableData.tableCode}</h2>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-8 mb-8 border-b border-stone-100 pb-8">
                            ...
                            <div className="col-span-2">
                                ...
                                <p className="text-[#1A3A52] font-bold text-lg">
                                    {t("guestsCount", { count: tableData.capacity })}
                                </p>
                            </div>
                        </div>
