...
export const TablePagination: React.FC<TablePaginationProps> = ({
    ...
    return (
        <div className="flex flex-row justify-between items-center px-4 py-2 bg-[#D5BA98]/12 min-h-11 text-[#1A3A52]">
            <div className="flex items-center sticky left-4">
                <span className="text-navy-DEFAULT text-sm">{t('total')}</span>
                <span className="ml-1 font-bold text-[#1A3A52] text-sm">{totalCount}</span>
            </div>
